module Admin::AssetManagement
  class UserAssetsController < ApplicationAdminController
    ...
    def assets
      authorize :authorization, :read?
      @pundit_user = { account: current_account, function_access_code: FunctionAccessConstant::FA_ASSMGMT_DATA_ASSET }
        ...
        respond_to do |format|
          format.turbo_stream do
            ...
            render turbo_stream: turbo_stream.replace(
              "table_assets",
              partial: "admin/asset_management/user_assets/assets/turbo_table",
              locals: { assets: @assets, pagy: @pagy }
            )
          end
          format.html do
            logger.debug "fallback render"
            render partial: "admin/asset_management/user_assets/assets/turbo_table",
    ...
    private
      ...
      def set_function_access_code
        @function_access_code = FunctionAccessConstant::FA_ASSMGMT_USER_ASSET
      end
