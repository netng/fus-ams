  ...
  class InventoryLocationsController < ApplicationAdminController
    ...
    def rooms
      ...
      render turbo_stream: turbo_stream.replace(
        "rooms",
        partial: "admin/asset_management/assets/rooms",
        locals: { rooms: @rooms }
      )
    end
    ...
    def rooms_storage_units
      ...
      render turbo_stream: turbo_stream.replace(
        "rooms_storage_units",
        partial: "admin/asset_management/assets/rooms_storage_units",
    ...
    def rooms_storage_units_bins
      ...
      render turbo_stream: turbo_stream.replace(
        ...
        partial: "admin/asset_management/assets/rooms_storage_units_bins",
    ...
    private
      ...
      def set_function_access_code
        @function_access_code = FunctionAccessConstant::FA_INVMGMT_INVENTORY_LOCACTION
      end
