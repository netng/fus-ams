...
export default class extends Controller {
  ...
  activate(event) {
    ...
    this.itemTargets.forEach((item) => {
      item.classList.remove("rounded", "bg-blue-200", "font-bold");
    ...
    clickedItem.classList.add("rounded", "bg-blue-200", "font-bold");
  ...
  updateActiveMenu() {
    ...
    this.itemTargets.forEach((item) => {
      ...
      if (currentUrl.includes(menuPattern)) {
        item.classList.add("rounded", "bg-blue-200", "font-bold");
