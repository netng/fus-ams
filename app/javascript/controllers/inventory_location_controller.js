...
// Connects to data-controller="inventory-location"
  ...
  connect() {
    const tomSelect = new TomSelect(this.selectTarget,{
      ...
      load: (query, callback) => {
        ...
        var url = `/admin/inventory-management/inventories/find-assets-not-in-inventory?tagging_id=${encodeURIComponent(query)}&site_id=${this.siteId}`
            ...
            <div class="rounded p-4">
              ...
              <div>
                <a href="${url}" 
                  ...
                  data-action="click->inventory-location#open"
